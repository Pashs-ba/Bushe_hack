# Generated by Django 3.2.15 on 2023-06-24 10:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.IntegerField(choices=[(0, 'Root'), (1, 'Администратор'), (2, 'Доставчик')], default=backend.apps.authentication.utils.UserTypes['DELIVER'], verbose_name='Тип аккаунта')),
