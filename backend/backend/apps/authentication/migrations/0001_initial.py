    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.IntegerField(choices=[(0, 'Root'), (1, 'Менеджер'), (2, 'Курьер')], default=backend.apps.authentication.utils.UserTypes['COURIER'], verbose_name='Тип аккаунта')),
                ('is_active', models.BooleanField(default=True, verbose_name='Активный')),
                ('is_staff', models.BooleanField(default=False, verbose_name='Администратор')),
                ('first_name', models.CharField(max_length=100, verbose_name='Имя')),
                ('last_name', models.CharField(max_length=100, verbose_name='Фамилия')),
                ('photo_url', models.URLField(default=None, null=True, verbose_name='Аватар')),
